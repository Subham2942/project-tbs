...
const Cards = ({ img, title, text }: Props) => {
  return (
    <div
      ...
      className="px-4 pt-1 my-1 w-full lg:px-7 lg:pt-3 lg:rounded-lg lg:w-60"
    >
      <Image
        src={`/images/${img}.png`}
        alt="Hello"
      ...
      />
      <h1
        className="pt-8 pb-2 w-1/2 text-xs lg:text-sm"
        style={{ color: "#DCDCDC" }}
      >
        {title.toUpperCase()}
      </h1>
      <p
        style={{ color: "#8A8A8A", width: "100%" }}
...
const Events = () => {
  return (
    <div
      style={{ backgroundColor: "#141416", height: "1052px" }}
      className=" px-12 flex flex-col py-4 lg:flex-row "
    >
      <div
        style={{ backgroundImage: "url(/images/background/EventsBg.png)" }}
        className="  text-center pt-10 lg:pt-48 lg:w-2/5 mx-auto lg:mx-0"
      >
        <h1 className=" mx-auto text-3xl lg:text-6xl w-4/5 text-white">
          Events and Activities
        </h1>
        <p className="mx-auto text-xs lg:text-sm text-zinc-500 font-medium w-4/5 pb-5  lg:p-0">
          {" "}
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis dui
          interdum imperdiet platea nisi. Convallis mi felis proin risus neque.
          Ut
        </p>
      </div>
